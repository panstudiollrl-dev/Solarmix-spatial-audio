...
public class SolarSystemManager : MonoBehaviour
{
    ...
    void SpawnPlanet(int i)
    {
        ...
        #elif MESH_RIR_SPATIALIZER
        var meshRirSpatializer = go.AddComponent<MeshRIRSpatializer>();
        meshRirSpatializer.rate     = 0.50f;
        meshRirSpatializer.depth    = 0.55f;
        meshRirSpatializer.energy   = 0.60f;
        meshRirSpatializer.material = 0.35f;
        meshRirSpatializer.density  = 0.50f;
        #endif
